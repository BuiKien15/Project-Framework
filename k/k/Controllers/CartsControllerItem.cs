...
{
    public class CartsControllerItem : Controller
    {
        private readonly QuanLyBanHangContext _context;

        public CartsControllerItem(QuanLyBanHangContext context)
        {
            _context = context;
        }

        // GET: CartsControllerItem
        public async Task<IActionResult> Index()
        {
            var quanLyBanHangContext = _context.Carts.Include(c => c.Product).Include(c => c.User);
            return View(await quanLyBanHangContext.ToListAsync());
        }

        // GET: CartsControllerItem/Details/5
        ...
        // GET: CartsControllerItem/Create
        ...
        // POST: CartsControllerItem/Create
        ...
        // GET: CartsControllerItem/Edit/5
        ...
        // POST: CartsControllerItem/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: CartsControllerItem/Delete/5
        ...
        // POST: CartsControllerItem/Delete/5
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'QuanLyBanHangContext.Carts'  is null.");
            }
            var cart = await _context.Carts.FindAsync(id);
            if (cart != null)
            {
